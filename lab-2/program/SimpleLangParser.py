...
def serializedATN():
    return [
        ...
        3,0,2,4,0,3,1,0,1,2,1,0,3,4,1,0,5,6,44,0,7,1,0,0,0,2,11,1,0,0,0,
        4,23,1,0,0,0,6,8,3,2,1,0,7,6,1,0,0,0,8,9,1,0,0,0,9,7,1,0,0,0,9,10,
        1,0,0,0,10,1,1,0,0,0,11,12,3,4,2,0,12,13,5,13,0,0,13,3,1,0,0,0,14,
        15,6,2,-1,0,15,24,5,9,0,0,16,24,5,10,0,0,17,24,5,11,0,0,18,24,5,
        12,0,0,19,20,5,7,0,0,20,21,3,4,2,0,21,22,5,8,0,0,22,24,1,0,0,0,23,
        14,1,0,0,0,23,16,1,0,0,0,23,17,1,0,0,0,23,18,1,0,0,0,23,19,1,0,0,
        0,24,36,1,0,0,0,25,26,10,8,0,0,26,27,7,0,0,0,27,35,3,4,2,9,28,29,
        10,7,0,0,29,30,7,1,0,0,30,35,3,4,2,8,31,32,10,6,0,0,32,33,7,2,0,
...
class SimpleLangParser ( Parser ):
    ...
    class PowModContext(ExprContext):
        ...
        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterPowMod" ):
                listener.enterPowMod(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitPowMod" ):
                listener.exitPowMod(self)
            ...
            while _alt!=2 and _alt!=ATN.INVALID_ALT_NUMBER:
                if _alt==1:
                    ...
                    if la_ == 1:
                        ...
                        localctx = SimpleLangParser.PowModContext(self, SimpleLangParser.ExprContext(self, _parentctx, _parentState))
                        self.pushNewRecursionContext(localctx, _startState, self.RULE_expr)
                        self.state = 31
