...
class SimpleLangListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by SimpleLangParser#PowMod.
    def enterPowMod(self, ctx:SimpleLangParser.PowModContext):
        pass

    # Exit a parse tree produced by SimpleLangParser#PowMod.
